...
class HardwareInterface:
    ...
    def __getPortRanges(self, port='lpt1'):
        ...
        addrBase = {'lpt1' : 0x378, 'lpt2' : 0x278, 'mda' : 0x3bc}
        port = port.lower()
...
class ApparatusInterface(HardwareInterface):
    ...
    def solarAlign(self):
        ...
        self.moveDome('cw', SOLAR_ALIGN_THETA)
        
        return 1
        
    def getConnectionStatus(self):
        state = False # if we see this then the rain sensor has not been tripped
    ...
    def getRainPulse(self):
        ...
        #CHECK HEX-mask....might not be correct (it is jesse, 
        if(self.getStatusRangeState() & SENSE_RAIN) == SENSE_RAIN:
            state = False
...
def main():
    hwc = ApparatusInterface('lpt1')
    
    hwc.resetDataRange()
    hwc.resetControlRange()
