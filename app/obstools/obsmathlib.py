...
# ==============================================================================
# Time Manipulation/Conversion Functions
# ==============================================================================

def getIntervalSeconds(t_init, t_end):
    # convert each time to seconds
    t_init_sec = (t_init[0] * 3600) + (t_init[1] * 60) + t_init[2]
    t_end_sec  = (t_end[0] * 3600) + (t_end[1] * 60) + t_end[2]
    
    # subtract to get the interval
    int_seconds = t_end_sec - t_init_sec
    
    return int_seconds

def HoursToRightAscension(Hours):
    # convert RA in decimal hours to hh:mm:ss
    # Careful! Float precision dictates the accuracy of this function.
    RAinHours = Hours
...
# ==============================================================================
# Coordiante Transformation Functions
# ==============================================================================
...
def calculateHourAngle(RA, currentLMST):
    ...
    # make negative if HA is greater than 12 hours-
    if HA <= -12:
        HA = HA + 24
    elif HA >= 12:
        HA = HA - 24
...
# ==============================================================================
#
# This 'main' function is used to test the above functions. Since this module is
# almost exclusivly imported, this exits when the file is run.
#
...
def main():
    ...
    ra, dec, crud = epochConvert((0,0,0), (0,0,0), 2012.5)
    print epochJ2k(ra2k, dec2k)
