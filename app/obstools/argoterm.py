...
class ArgoInterface:
	# 38400
    def __init__(self, port=0, baudrate=38400, timeout=1, echo=False):
        self.port = port
        self.baudrate = baudrate
        self.timeout = timeout
        
        self.serial = serial.Serial(self.port, baudrate=38400, timeout=1, writeTimeout=1)
...
def main():
    ...
    #argo.fromPlanetarium('HOME_TEST', (0,0,0), (-20,-30,-0), 'STAR', 1.0, o_desc=None)
    #print(argo.getDateTime())
